...
export default function Sidebar() {
    return <div className="flex flex-col gap-3">
        <div className="flex gap-2 py-3  items-center px-2 rounded-lg  text-blue-700 bg-sky-100 cursor-pointer">
        ...
        <div className="flex gap-2 py-3 text-gray-500 items-center px-2 rounded-lg hover:bg-sky-50 hover:text-blue-700 cursor-pointer">
